...
import { 
  ...
  FileText, Plus, X, ArrowLeft, Save, AlertCircle 
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg p-4 sm:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card shadow-2xl overflow-hidden border-0 animate-fade-in">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                ...
                {(!formData.skills || formData.skills.length === 0) && (
                  <p className="text-xs text-gray-400 italic py-2">No skills added yet. Add at least 3 for better matching.</p>
                )}
              </div>
            </div>
