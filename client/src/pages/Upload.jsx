...
import { FilePlus, Brain, XCircle, CheckCircle, Zap } from 'lucide-react';
...
const Upload = () => {
  ...
  const UploadBox = ({ title, type, file, errorMsg, accept }) => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-gray-50 dark:bg-dark-bg py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch justify-center gap-10 lg:gap-6 relative">
